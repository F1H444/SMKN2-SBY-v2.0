// src/app/alumni/alumni-terbaik.tsx
...
// Data Alumni dipindahkan ke luar komponen untuk stabilitas referensi
const alumniData = [
  {
    id: 1,
...
const AlumniPage = () => {
  ...
  const filteredAlumni = useMemo(() => {
    ...
    // `alumniData` dihapus dari dependency array karena sudah menjadi konstanta di luar komponen
