...
const AlumniPage = () => {
  ...
  const alumniData = [
    {
      id: 1,
      name: "Marsekal Muda Nurtanio",
      image: "https://api.dicebear.com/7.x/avataaars/svg?seed=Nurtanio",
      department: "Teknik Penerbangan",
      year: "1940",
      position: "Perintis Industri Penerbangan",
      company: "PT Dirgantara Indonesia",
      achievement:
        "Namanya diabadikan di Pabrik Pesawat Terbang Indonesia (Bandung).",
      rating: 5,
    },
    {
      id: 2,
      name: "Marsekal Suwoto Soekandar",
      image: "https://api.dicebear.com/7.x/avataaars/svg?seed=Suwoto",
      department: "Teknik Mesin",
      year: "1945",
      position: "Marsekal TNI AU",
      company: "TNI Angkatan Udara",
      achievement:
        "Perwira tinggi TNI AU yang berkontribusi dalam pembangunan pertahanan udara.",
      rating: 5,
    },
    {
      id: 3,
      name: "Jenderal Polisi Budi Darma",
      image: "https://api.dicebear.com/7.x/avataaars/svg?seed=BudiDarma",
      department: "Teknik Elektro",
      year: "1960",
      position: "Jenderal Polisi (Purnawirawan)",
      company: "Kepolisian RI",
      achievement:
        "Pejabat tinggi Polri yang berkontribusi dalam reformasi kepolisian.",
      rating: 5,
    },
    {
      id: 4,
      name: "Jenderal Sumitro",
      image: "https://api.dicebear.com/7.x/avataaars/svg?seed=Sumitro",
      department: "Teknik Sipil",
      year: "1955",
      position: "Jenderal TNI",
      company: "Tentara Nasional Indonesia",
      achievement: "Tokoh militer yang berperan penting dalam sejarah TNI.",
      rating: 5,
    },
    {
      id: 5,
      name: "Jenderal Widjojo Soejono",
      image: "https://api.dicebear.com/7.x/avataaars/svg?seed=Widjojo",
      department: "Teknik Mesin",
      year: "1958",
      position: "Jenderal TNI",
      company: "Tentara Nasional Indonesia",
      achievement: "Perwira tinggi yang berkontribusi dalam pembangunan TNI.",
      rating: 5,
    },
    {
      id: 6,
      name: "Letjen Bambang Triantoro",
      image: "https://api.dicebear.com/7.x/avataaars/svg?seed=Bambang",
      department: "Teknik Bangunan",
      year: "1965",
      position: "Sekretaris Jenderal (Purnawirawan)",
      company: "Depdikbud",
      achievement: "Mantan Sekjen Departemen Pendidikan dan Kebudayaan.",
      rating: 5,
    },
    {
      id: 7,
      name: "Abdul Azis",
      image: "https://api.dicebear.com/7.x/avataaars/svg?seed=AbdulAzis",
      department: "Teknik Otomotif",
      year: "1970",
      position: "Pendiri Perusahaan",
      company: "Wirausaha Sukses",
      achievement:
        "Pendiri perusahaan yang berkembang pesat di bidang otomotif.",
      rating: 5,
    },
    {
      id: 8,
      ...
      department: "Teknik Mesin",
      year: "1975",
      position: "Insinyur Senior",
      company: "Industri Manufaktur",
      achievement:
        "Kontributor dalam pengembangan industri manufaktur nasional.",
      rating: 4,
    },
  ];
